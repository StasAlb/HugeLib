    ...
    public class GOSTsymmManaged : GOSTsymm
    {
        ...
        public void LoadTestSBoxes(int i)
        {
            switch (i)
            {
                ...
                case 3:
                    SBoxesValue = new byte[8, 16]{
                        {9,6,3,2,8,0xb,1,7,0xa,4,0xe,0xf,0xc,0,0xd,5},
                        {3,7,0xe,9,8,0xa,0xf,0,5,2,6,0xc,0xb,4,0xd,1},
                        {0xe,4,6,2,0xb,3,0xd,8,0xc,0xf,5,0xa,0,7,1,9},
                        {0xe,7,0xa,0xc,0xd,1,3,9,0,2,0xb,4,0xf,8,5,6},
                        {0xb,5,1,9,8,0xd,0xf,0,0xe,4,2,3,0xc,7,0xa,6},
                        {3,0xa,0xd,0xc,1,2,0,0xb,7,5,9,4,8,0xf,0xe,6},
